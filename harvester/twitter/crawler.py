...
def main_search(id_lst, bearer_token, client, couchdb_server, city_name, topic, args):
    ...
    if topic == "environment" and city_name == "melbourne":
        ...
        if city_name == "melbourne":
            query = '(australia OR #australia OR melbourne OR #melbourne OR Victoria OR #Victoria OR VIC OR #VIC OR @healthgovau OR #melbournecbd OR @VicGovDH OR @VictorianCHO) (#lockdown OR #COVIDIOTS OR #antivaxxers OR immunisation OR #immunisation OR #vaccines OR #MaskUp OR #WearAMask OR #CovidIsNotOver OR vaccine OR coronavirus OR #vaccination OR #vaccine OR #Covid19 OR AstraZeneca OR #AstraZeneca OR Pfizer OR #Pfizer OR #Covid OR Covid OR #COVID19 OR Covid19 OR #CovidVaccine OR Omicron OR #COVID19Vic OR #covid19aus)'
