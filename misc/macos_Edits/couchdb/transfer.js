const twitterDB = `http://${process.env.user}:${process.env.pass}@localhost:${process.env.master_port}/twitter`;
const twitterpartDB = `http://${process.env.user}:${process.env.pass}@localhost:${process.env.master_port}/twitterpart`;
